...
const work = [
    ...
    // ==================== Personal ====================
    new MasonryGridItem().setImage("https://img.vsco.co/375c41/273964258/6ab2a7fe69477831e7980f83/vsco_092226.jpg")
                         .addTag(workTypes.personal.tag)
                         .setAltText("A painting of a mountain path with an old wooden sign."), 
    new MasonryGridItem().setImage("https://img.vsco.co/375c41/273964258/6a52ce52d0a85b99e88592ce/vsco_071126.jpg")
                         .addTag(workTypes.personal.tag)
                         .setAltText("A painting of a brown cow"), 
    new MasonryGridItem().setImage("https://img.vsco.co/375c41/273964258/6a6500e1884c92b0277a1d0c/vsco_072526.jpg")
                         .addTag(workTypes.personal.tag), 
    new MasonryGridItem().setImage("https://img.vsco.co/375c41/273964258/6a320f62a02f07ba50abea90/vsco_061626.jpg")
                         .addTag(workTypes.personal.tag),
    new MasonryGridItem().setImage("https://img.vsco.co/375c41/273964258/6988a88c51c31bb58b9f7c7d/vsco_020826.jpg")
                         .addTag(workTypes.personal.tag)
                         .setAltText("A picture of a zine about coffee."),
    new MasonryGridItem().setImage("https://img.vsco.co/375c41/273964258/6972f7619c17524c80e5bd55/CafeConLeche.png")
                         .addTag(workTypes.personal.tag)
                         .setAltText("A digital painting of a coffee on a wooden table."),
